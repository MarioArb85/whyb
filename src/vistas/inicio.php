...
class inicio {
  ...
  static function construye() {
    ...
    <div id='cuerpo'>
    <div id='textInicio'>
      <p>In nam vocent adipiscing. Id sed sonet nobis fuisset, per id stet sale epicurei, ad primis dolores eos. Cu quodsi commune usu. Splendide laboramus no mel, te qui adhuc exerci. Adhuc porro eam ut, vidit antiopam neglegentur ne sea.</p>
      <br/>
